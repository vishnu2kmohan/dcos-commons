...
nifi_version = os.getenv('NODE_COUNT', '1.3.0')
nifi_node_count = os.getenv('NODE_COUNT', 3)
nifi_authorizers_xml_file = '{}/nifi-{}/authorizers.xml'.format(mesos_sandbox, 
        nifi_version)
...
with open(nifi_authorizers_xml_file, 'wb') as nifi_authorizer_xml:
