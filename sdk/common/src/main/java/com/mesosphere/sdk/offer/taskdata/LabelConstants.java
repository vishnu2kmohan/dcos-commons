...
class LabelConstants {
    ...
    /** Labels inside of resource reservations, for internal tracking/bookkeeping by the Scheduler */
    static final String RESOURCE_ID_KEY = "resource_id";
    static final String RESOURCE_PORT_NAME_PREFIX = "port_name_";
}
